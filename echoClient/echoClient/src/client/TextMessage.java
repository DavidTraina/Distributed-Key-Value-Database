...
/** Represents a simple text message, which is intended to be received and sent by the server. */
public class TextMessage implements Serializable {
  ...
  /**
   * Constructs a TextMessage object with a given array of bytes that forms the message.
   *
  ...
  /**
   * Constructs a TextMessage object with a given String that forms the message.
   *
   ...
   *
   * @return the content of this message as an array of bytes in ASCII coding.
   */
