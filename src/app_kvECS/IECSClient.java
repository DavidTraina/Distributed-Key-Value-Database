...
public interface IECSClient {
  /**
   * Starts the storage service by calling start() on all KVServer instances that participate in the
   * service.\
   *
  ...
  /**
   * Create a new KVServer with the specified cache size and replacement strategy and add it to the
   * storage service at an arbitrary position.
   *
   ...
   * persisted data, and remain in state stopped. NOTE: Must call setupNodes before the SSH calls to
   * start the servers and must call awaitNodes before returning
   *
